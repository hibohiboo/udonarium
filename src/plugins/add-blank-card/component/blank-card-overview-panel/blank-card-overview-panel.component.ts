...
@Component({
  selector: 'blank-card-overview-panel',
  templateUrl: './blank-card-overview-panel.component.html',
  styleUrls: ['./blank-card-overview-panel.component.css'],
...
export class BlankCardOverviewPanelComponent implements OnChanges, AfterViewInit, OnDestroy {
  ...
  get card(): BlankCard | BlankCardStack {
  ...
  get displayCard(): BlankCard {
    if (this.tabletopObject instanceof BlankCard) return this.tabletopObject;
    if (this.tabletopObject instanceof BlankCardStack) return this.tabletopObject.topCard;
    return null;
  }
