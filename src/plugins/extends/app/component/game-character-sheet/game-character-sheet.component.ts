...
import { initGameCharacterSheetComponentForWritableText, isCardWritable } from 'src/plugins/add-card-text-writable/extend/component/game-character-sheet/game-character-sheet.component';

@Component({
  selector: 'game-character-sheet-extend-plus',
...
export class GameCharacterSheetComponentExtendPlus implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor(
    ...
    initGameCharacterSheetComponentForWritableText(this);
  }
