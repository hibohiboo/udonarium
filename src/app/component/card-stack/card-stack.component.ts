...
import { addContextMenuAutoSelfViewCardFromDeck, setAutoSelfViewCardFromDeck } from 'src/plugins/auto-self-view-mode/extend/component/card-stack/card-stack.component';
...
export class CardStackComponent implements OnChanges, AfterViewInit, OnDestroy {
  ...
  private makeContextMenu(): ContextMenuAction[] {
    let actions: ContextMenuAction[] = [];
    actions.push(...addContextMenuAutoSelfViewCardFromDeck());
    actions.push({
      name: '１枚引く', action: () => {
    ...
    actions.push(...drawNCardsContextMenu(this));
    actions.push(ContextMenuSeparator);
    actions.push({
    ...
    actions.push(...handCardStackContextMenu(this));
    ...
    actions.push(...cardBackImageAllChangeContextMenu(this));
    actions.push(...rotateOffContextMenuCardStack(this));
