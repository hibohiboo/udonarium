...
import { DiceTablePalette } from '../../class/dice-table-palette';
...
//    return !this.isEmpty && !this.isDeleted;
  ...
  save() {
    ...
    this.saveDataService.saveGameObjectAsync(this.selectedTable, 'dice_table_' + this.selectedTable.name, percent => {
