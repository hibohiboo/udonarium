...
export class HandStorageService {
  private handStorageCache = new TabletopCache<HandStorage>(() => ObjectStore.instance.getObjects(HandStorage));
  get handStorages(): HandStorage[] { return this.handStorageCache.objects; }
  constructor() {
